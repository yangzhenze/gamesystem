...
public class DateUtil {
	...
	public static void main(String [] args){
		...
		System.out.println(DateUtil.getIntervalDays(DateUtil.stringToDate("2019-01-10","yyyy-MM-dd"),DateUtil.stringToDate("2018-12-12","yyyy-MM-dd")));


		Date date = dateUtil.dateAdd(3,0,new Date());
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
		System.out.println(simpleDateFormat.format(date));
		System.out.println(DateUtil.getIntervalDays(date,new Date()));
		DateUtil.getIntervalDays(new Date(),date);
	}
}
